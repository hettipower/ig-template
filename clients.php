...
<div class="page-container">
    <section class="section clients-content">
        <div class="inner">
            ...
            <div class="client-carousel <?php echo (!$detect->isMobile() || !$detect->isTablet()) ? 'pc-carousel' : '' ; ?>">
    ...
    <div id="client1" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            ...
            <div class="content">
                ...
                <p>— James - Managing Director</p>
            </div>
        </div>
    </div>

    <div id="client2" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client3" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client4" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client5" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client6" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client7" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
    ...
    <div id="client8" class="client-content" style="display:none;max-width:800px;">
        <div class="content-inner">
            <div class="details">
